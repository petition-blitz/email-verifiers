...
function mockResponse (address, risk) {
...
describe('mailgun', function () {
  describe('verify()', function () {
    ...
    it('resolves to false for unacceptable risks', async function () {
      mockResponse('test4@example.com', 'high');
